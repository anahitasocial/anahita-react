...
const addRequest = (node) => {
  return {
    type: 'COMMENTS_LIKES_ADD_REQUEST',
    node,
  };
};

const addSuccess = (newNode) => {
  const comment = { ...newNode };
  comment.voteUpCount += 1;
  comment.isVotedUp = true;

  return {
    type: 'COMMENTS_LIKES_ADD_SUCCESS',
    node: comment,
  };
};
...
const addFailure = (response) => {
  return {
    type: 'COMMENTS_LIKES_ADD_FAILURE',
...
const deleteRequest = (node) => {
  return {
    type: 'COMMENTS_LIKES_DELETE_REQUEST',
    node,
  };
};
...
const deleteSuccess = (newComment) => {
  ...
  return {
    type: 'COMMENTS_LIKES_DELETE_SUCCESS',
    node: comment,
  };
};
...
const deleteFailure = (error) => {
  return {
    type: 'COMMENTS_LIKES_DELETE_FAILURE',
    error: error.message,
  };
};
